...
class GenerateMeasurementsTask extends DefaultTask {
        ...
        try {
            ...
            if (lineCoverage) {
                ...
                throw new IllegalStateException(
                        "Cannot find line coverage section in the report: $path.")
            }
        } catch (FileNotFoundException e) {
            project.logger.
                    warn("Cannot find coverage report for project: $_project.")
    ...
    private def generateJson(pullRequestNumber) {
        ...
        println ColumnName.PULL_REQUEST_ID
        println ColumnName.SDK_ID
        println ColumnName.COVERAGE_PERCENT
